...
# stuff for python virtualenvwrapper
export WORKON_HOME=~/myfiles/dev
source /usr/bin/virtualenvwrapper_lazy.sh

# nnn envars
export NNN_PLUG='d:dragdrop;p:preview-tabbed;f:fzopen'
alias nnn="nnn -rx"
alias nnp="nnn -rx -P p"
export NNN_FIFO="/tmp/nnn.fifo"
export NNN_BMS='p:~/myfiles/projects;U:/run/media/pritom;D:~/Downloads/;B:~/myfiles/bluetooth'
